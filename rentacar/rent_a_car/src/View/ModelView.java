...
public class ModelView extends Layout {
    ...
    public ModelView(Model model) {
        ...
        for (Brand brand : this.brandManager.findAll()) {
            this.cmb_brand.addItem(new ComboItem(brand.getId(), brand.getName())); //popupta ögeleri ekler.
        }
        ...
        // Güncelleme işlemi yaparken kutucukların dolu olmasını sağlar.
        if (this.model.getId() != 0) {
            ...
            this.cmb_model_fuel.getModel().setSelectedItem(this.model.getType());
            this.cmb_model_fuel.getModel().setSelectedItem(this.model.getYear());
            this.cmb_model_fuel.getModel().setSelectedItem(this.model.getGear());
